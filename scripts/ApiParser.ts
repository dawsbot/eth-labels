...
export class ApiParser{
    ...
    private filterResponse(data :  { d: { data: Array<{tokenName:string, tokenSymbol:string, tokenImage:string, website:string, contractAddress:string}> } }): Array<TokenRow> {
        data?.d?.data?.forEach((token: {tokenName:string, tokenSymbol:string, tokenImage:string, website:string, contractAddress:string}) => {
            ...
            token.contractAddress = $3('a').attr('data-bs-title') || token.contractAddress;
        });
    ...
    public async fetchTokens(tokenName:string, cookie:string): Promise<ReadonlyArray<TokenRow>>{
    ...
    .then((data: { d: { data: Array<{tokenName:string, tokenSymbol:string, tokenImage:string, website:string, contractAddress:string, address:string}> } }) => {
